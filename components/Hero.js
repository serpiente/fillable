const Arrow = ({ className }) => (
  <svg
    className={`shrink-0 fill-primary stroke-primary ${className}`}
    viewBox="0 0 138 138"
    xmlns="http://www.w3.org/2000/svg"
    style={{ transform: "rotate(-100deg) scaleX(1.4)" }}
    strokeWidth="8"
    strokeLinecap="round"
    ...
    <section className="max-w-7xl mx-auto bg-base-100 flex flex-col lg:flex-row items-center justify-center gap-16 lg:gap-20 px-8 py-8 lg:py-20">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-10">
        <div className="flex flex-col items-center gap-3">
          <img
            src="/pdf-original.png"
            alt="PDF original"
            className="w-64 md:w-80 rounded-lg shadow-xl"
          />
          <span className="text-sm opacity-70">PDF Original</span>
        </div>

        <Arrow className="w-14 h-14 md:w-16 md:h-16" />
        ...
        <div className="flex flex-col items-center gap-3">
          <img
            ...
            className="w-64 md:w-80 rounded-lg shadow-xl"
          />
          <span className="text-sm opacity-70">PDF Filled</span>
        </div>
      </div>
    </section>
  );
